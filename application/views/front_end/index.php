        ...
        <div class="col-md-10 col-lg-10">
          ...
          <div class="row mt-4 g-2">
            ...
            <div class="col-6 col-md-4 col-lg-2">
              <a type="button" href="#" class="btn card malioboro malioboro1 ganti_bg" style="font-family: 'Assistant';font-size: 36px; padding-top: 4px;">
            ...
            <div class="col-6 col-md-4 col-lg-2">
              <a type="button" href="#" class="btn card malioboro malioboro2" style="font-family: 'Assistant';font-size: 36px; padding-top: 4px;">
                
                      <img src="<?= base_url('assets/img/logo_kraton.png')?>" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title text-center font-judul">Malioboro 2</h5> <!-- this text get from database -->
                      </div>
            ...
            <div class="col-6 col-md-4 col-lg-2">
              <a type="button" href="#" class="btn card malioboro malioboro3" style="font-family: 'Assistant';font-size: 36px; padding-top: 4px;">
                      <img src="<?= base_url('assets/img/logo_kraton.png')?>" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title text-center font-judul">Malioboro 3</h5> <!-- this text get from database -->
                      </div>
              </a>
            </div>
            
            <div class="col-6 col-md-4 col-lg-2">
              <a type="button" href="#" class="btn card malioboro malioboro4" style="font-family: 'Assistant';font-size: 36px; padding-top: 4px;">
                      <img src="<?= base_url('assets/img/logo_kraton.png')?>" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title text-center font-judul">Malioboro 3</h5> <!-- this text get from database -->
                      </div>
            ...
            <div class="col-6 col-md-4 col-lg-2">
              <a type="button" href="#" class="btn card malioboro malioboro5" style="font-family: 'Assistant';font-size: 36px; padding-top: 4px;">
                      <img src="<?= base_url('assets/img/logo_kraton.png')?>" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title text-center font-judul">Malioboro 3</h5> <!-- this text get from database -->
                      </div>
  ...
  <main id="main">
        ...
        <div class="container rata">
          <div class="col-lg-12 my-4">
                      ...
                      <div class="card custom-card shadow">
                        <div class="card-body">
                          <div class="row">
                            <div class="col-2 col-md-2 col-lg-1 py-2">
    ...
    <section id="langkah">
      <div class="container rata bg-white">
        <div class="pt-5 text-center">
            <h1 class="display-4 judul-2"><b>Ikuti 4 Langkah Mudah</b></h1><br>
    ...
    <section id="regulasi">
      <div class="container bg-white">
        <div class="px-4 pt-5 text-center">
            <h1 class="display-4 judul-2"><b>Lihat Regulasi</b></h1><br>
    ...
    <section id="testimoni" class="testimoni">
      <div class="container bg-white">
        <div class="row">
        <div class="px-4 pt-5 text-center ">
            <h1 class="display-4 judul-2"><b>Testimoni</b></h1><br>
